...
const Block3 = (props: Block3Props) => {
  return (
    <Element name="Block3">
      <ScrollAnimation animateOnce={true} offset={0} animateIn="animate__fadeInUp">
        <Container fluid className="Block3">
          ...
          <Container className="Block3__contaner d-block d-sm-none">
            ...
            <Row className="Block3__sliderNav m-0 justify-content-between pt-4">
              <div className="Services__prev">
                <img src="/img/svg/arrowLeft.svg" alt="" />
              </div>
              <div className="Services__next">
                <img src="/img/svg/arrowRight.svg" alt="" />
              </div>
            </Row>
          </Container>
        </Container>
